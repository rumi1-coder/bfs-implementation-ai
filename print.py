...
class Puzzle:
	...
	def neighbors(self, state):
        #defining amatrix and coping values into it
		mat, (row, col) = state
        #emptylist for holding all posible neigbors of a node
		results = []
...
start = np.array([[1, 2, 3], [8, 0, 4], [7, 6, 5]])
goal = np.array([[0, 8, 1], [2, 4, 3], [7, 6, 5]])
